...
<div id="user-content-toc">
  <ul align="center">
    <summary><h2 style="display: inline-block">Aprendiendo y construyendo cada día 🚀</h2></summary>
  </ul>
</div>
...
- 🏛️ Actualmente preparando oposiciones de **TAI (Tecnologías de la Información del Estado)**

- 🌐 He creado mi propia web: **https://micalculadora.es**

- 🚀 Interesado en crear proyectos útiles, optimizados para SEO y monetización

- 🌱 Actualmente mejorando en **JavaScript avanzado, APIs, rendimiento web y backend**

- 🛠️ Tecnologías principales: **JavaScript, PHP, MySQL, HTML, CSS**

- 💬 Puedes preguntarme sobre **desarrollo web, WordPress, SEO o proyectos reales**
